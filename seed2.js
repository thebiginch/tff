  ...
  function randPhoto() {
      ...
      return function() {
          ...
          if (i < 49) return ''+`/images/${i++}.jpg`;
          else if (i < 73) return ''+`/images/${i++}.png`;
          else if (i<103) return ''+`/images/${i++}.jpg`
          else { i++;
              return null;
          }
  ...
  db.sync({ force: true })
      ...
      .then(function(createdUsers) {
          ...
          // }
          return Promise.all([createdUsers[29].addInst(createdUsers[101], { IR: true }), +createdUsers[27].addInst(createdUsers[101], { IR: true }), +createdUsers[25].addInst(createdUsers[101], { IR: true }), +createdUsers[23].addInst(createdUsers[101], { IR: true }), +createdUsers[22].addInst(createdUsers[101], { IR: true })]);
